...
python main.py --src ja --tgt en --dataset aspec --device 0 --S pix --vision_constraint
python main.py --src ja --tgt en --dataset opus100 --device 0 --S pix --vision_constraint